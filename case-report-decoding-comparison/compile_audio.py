...
plt.tight_layout()
plt.savefig("/scratch/timonmerk/get_data_NBU/perceptparser/case-report-decoding-comparison/top_15_correlations_madrs_audio.pdf")


df_neural = pd.read_csv("Audio/psd_specparam_features_0_40Hz.csv")
